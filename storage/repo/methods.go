...
type IAdminStorage interface {
	...
	SelectOne(ctx context.Context, req entities.APIDetails, arg []interface{}, dest interface{}) error
	SelectList(ctx context.Context, req entities.APIDetails, arg []interface{}, dest interface{}) error
